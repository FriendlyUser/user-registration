    ...
    <header class="header-global">
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
            <router-link slot="brand" class="navbar-brand mr-lg-5" to="/">
                <h4 class="text-secondary">Float</h4>
            </router-link>
                    ...
                    <div class="dropdown-menu-inner">
                        <a href="https://demos.creative-tim.com/vue-argon-design-system/documentation/"
                           class="media d-flex align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <h6 class="heading text-primary mb-md-1">Bootstrap</h6>
                                <p class="description d-none d-md-inline-block mb-0">Built with Bootstrap, the
                        ...
                        <a href="https://demos.creative-tim.com/vue-argon-design-system/documentation/"
                           class="media d-flex align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <h5 class="heading text-warning mb-md-1">Google OAuth</h5>
                                <p class="description d-none d-md-inline-block mb-0"> Example Golang Backend for login with google.</p>
                            </div>
                        </a>
                    </div>
                </base-dropdown>
